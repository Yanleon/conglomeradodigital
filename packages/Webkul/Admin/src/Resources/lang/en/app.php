        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'footer-content' => [
                    ...
                    'description'          => 'Control what shows in the footer and its content.',
                    'show-logo'            => 'Show Logo',
                    'logo'                 => 'Logo',
                    ...
                    'footer-bottom-bg'     => 'Bottom bar background',
                    'show-contacts'        => 'Show contacts',
                    'contacts'             => 'Contact info',
                    'contacts-description' => 'Add phone, email, address or any contact item.',
                    'add-contact'          => 'Add Contact',
                    'no-contacts'          => 'No contact items yet.',
                    'contact-form-title'   => 'Contact item',
                    'contact-label'        => 'Label',
                    'contact-value'        => 'Value',
                    'contact-url'          => 'URL',
                    'sort-order'           => 'Sort order',
                    'sections'             => 'Sections',
                    'show-links'           => 'Show link columns',
                    'show-newsletter'      => 'Show newsletter',
                    'show-social'          => 'Show social icons',
                    'social-title'         => 'Social title',
                    'bottom-text'          => 'Bottom text',
                    'bottom-text-hint'     => 'Tip: use {year_range} or {current_year} placeholders.',
                ...
                'popup-widget' => [
                    'title'               => 'Popup Widget',
                    'description'         => 'Show a promotional popup when users open the page.',
                    'enabled'             => 'Enabled',
                    'start-at'            => 'Start at',
                    'end-at'              => 'End at',
                    'display-on'          => 'Display on',
                    'display-on-all'      => 'All pages',
                    'display-on-home'     => 'Home only',
                    'display-on-urls'     => 'Specific URLs',
                    'urls-hint'           => 'One path per line. Example: /, /collections/sale',
                    'frequency'           => 'Frequency',
                    'frequency-always'    => 'Always',
                    'frequency-session'   => 'Once per session',
                    'frequency-once'      => 'Once per browser',
                    'frequency-daily'     => 'Once per day',
                    'frequency-weekly'    => 'Once per week',
                    'auto-close'          => 'Auto close (seconds)',
                    'content-type'        => 'Content type',
                    'content-image'       => 'Image + Link',
                    'content-html'        => 'HTML',
                    'content-link'        => 'Link (Product/Category/URL)',
                    'banner'              => 'Banner image',
                    ...
                    'editor'              => 'Editor',
                    'preview'             => 'Preview',
                    'html-images'         => 'Images for HTML',
                    'html-images-hint'    => 'Upload images and then use their URLs in your HTML (e.g. <img src="/storage/...">).',
                    'current-images'      => 'Current images',
                    'no-show-again'       => 'Show "Don\'t show again" checkbox',
                    'overlay-click-close' => 'Close on overlay click',
                    'testing-hint'        => 'Testing: if popup behavior seems sticky, clear saved browser popup state (cookies/storage).',
                    'reset-state'         => 'Reset Popup State',
                    'reset-success'       => 'Popup state cleared for this browser.',
                    'reset-warning'       => 'Could not clear popup state completely.',
                ],
                'yes'                    => 'Yes',
            ],
