        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'popup-widget'      => 'Popup de Promoción',
            ...
            'edit' => [
                ...
                'footer-content' => [
                    ...
                    'description'          => 'Controla qué se muestra en el footer y su contenido.',
                    'show-logo'            => 'Mostrar logo',
                    'logo'                 => 'Logo',
                    'current-logo'         => 'Logo actual',
                    'view'                 => 'Ver',
                    'about-heading'        => 'Título (About)',
                    'about-text'           => 'Texto (About)',
                    'footer-bg'            => 'Fondo del footer',
                    'footer-bottom-bg'     => 'Fondo barra inferior',
                    'show-contacts'        => 'Mostrar contactos',
                    'contacts'             => 'Información de contacto',
                    'contacts-description' => 'Agrega teléfono, correo, dirección o cualquier ítem de contacto.',
                    'add-contact'          => 'Agregar contacto',
                    'no-contacts'          => 'Aún no hay ítems de contacto.',
                    'contact-form-title'   => 'Ítem de contacto',
                    'contact-label'        => 'Etiqueta',
                    'contact-value'        => 'Valor',
                    'contact-url'          => 'URL',
                    'sort-order'           => 'Orden',
                    'sections'             => 'Secciones',
                    'show-links'           => 'Mostrar columnas de enlaces',
                    'show-newsletter'      => 'Mostrar newsletter',
                    'show-social'          => 'Mostrar redes sociales',
                    'social-title'         => 'Título redes sociales',
                    'bottom-text'          => 'Texto inferior',
                    'bottom-text-hint'     => 'Tip: usa los placeholders {year_range} o {current_year}.',
                    'year-start'           => 'Año inicial',
                ...
                'popup-widget' => [
                    ...
                    'description'         => 'Muestra un popup promocional cuando el usuario abre la página.',
                    'enabled'             => 'Activo',
                    'start-at'            => 'Inicio',
                    'end-at'              => 'Fin',
                    'display-on'          => 'Mostrar en',
                    'display-on-all'      => 'Todas las páginas',
                    'display-on-home'     => 'Solo home',
                    'display-on-urls'     => 'URLs específicas',
                    'urls-hint'           => 'Una ruta por línea. Ej: /, /collections/sale',
                    'frequency'           => 'Frecuencia',
                    'frequency-always'    => 'Siempre',
                    'frequency-session'   => 'Una vez por sesión',
                    'frequency-once'      => 'Una vez por navegador',
                    'frequency-daily'     => 'Una vez al día',
                    'frequency-weekly'    => 'Una vez a la semana',
                    'auto-close'          => 'Auto cerrar (segundos)',
                    'content-type'        => 'Tipo de contenido',
                    'content-image'       => 'Imagen + Enlace',
                    'content-html'        => 'HTML',
                    'content-link'        => 'Enlace (Producto/Categoría/URL)',
                    'banner'              => 'Imagen del banner',
                    'current-banner'      => 'Banner actual',
                    'link-url'            => 'URL del enlace',
                    'link-text'           => 'Texto del botón',
                    'html'                => 'HTML',
                    'css'                 => 'CSS',
                    'editor'              => 'Editor',
                    'preview'             => 'Vista previa',
                    'html-images'         => 'Imágenes para HTML',
                    'html-images-hint'    => 'Sube imágenes y usa sus URLs en tu HTML (ej: <img src="/storage/...">).',
                    'current-images'      => 'Imágenes actuales',
                    'no-show-again'       => 'Mostrar checkbox "No mostrar de nuevo"',
                    'overlay-click-close' => 'Cerrar al hacer click fuera',
                    'testing-hint'        => 'Pruebas: si el popup no reaparece como esperas, limpia el estado guardado en navegador (cookies/storage).',
                    'reset-state'         => 'Reset Popup (pruebas)',
                    'reset-success'       => 'Estado del popup limpiado en este navegador.',
                    'reset-warning'       => 'No se pudo limpiar completamente el estado del popup.',
                ],
                'yes'                           => 'Sí',
            ],
