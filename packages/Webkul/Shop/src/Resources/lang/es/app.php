    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '<a href="https://www.MaxSystems.com" target="_blank">Hecho en Colombia con <i class="icon-heart"></i> por MaxSystems</a> <span> | Conglomerado Digital - Todos los derechos reservados 2026-' . date('Y') . '</span>',
                'locale'                 => 'Idioma',
                'newsletter-text'        => '¡No te pierdas lo mejor deja tu correo!',
