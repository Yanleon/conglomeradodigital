    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '<a href="https://www.MaxSystems.com" target="_blank">   Hecho en Colombia con <i class="icon-heart"></i> por MaxSystems </a> <span> | AngelShopCol - Todos los derechos reservados 2022-2025</span>',
                'locale'                 => 'Idioma',
                'newsletter-text'        => '¡No te pierdas lo mejor de AngelShopCol en tu correo!',
